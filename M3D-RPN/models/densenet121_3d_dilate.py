...
class DetectionHead(nn.Module):
    ...
    def __init__(self, phase, conf):
        ...
        num_baseout_feature = 1024
        self.prop_feats = nn.Sequential(
            nn.Conv2d(num_baseout_feature, 512, 3, padding=1),
            nn.ReLU(inplace=True),
        )
...
def my_build(conf, phase='train'):
    ...
    feature_extractor = FeatureExtractor(phase, densenet121.features, conf)
    detection_head = DetectionHead(phase, conf)
    ...
    return feature_extractor, detection_head
