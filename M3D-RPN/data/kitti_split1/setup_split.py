...
kitti_raw = dict()
kitti_raw['cal'] = os.path.join(base_data, 'kitti', 'train', 'calib')
kitti_raw['ims'] = os.path.join(base_data, 'kitti', 'train', 'image_2')
kitti_raw['lab'] = os.path.join(base_data, 'kitti', 'train', 'label_2')
kitti_raw['pre'] = os.path.join(base_data, 'kitti', 'train', 'prev_2')
